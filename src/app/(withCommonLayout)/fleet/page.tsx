...
const CTAButton = ({
  ...
  <Link
    ...
    <motion.span
      className={`inline-flex items-center px-8 py-4 bg-orange-600 hover:bg-white hover:text-orange-600 text-black font-black uppercase italic tracking-widest text-[10px] sm:text-xs rounded-none skew-x-[-12deg] shadow-[0_0_20px_rgba(234,88,12,0.3)] transition-all duration-500 ${className}`}
