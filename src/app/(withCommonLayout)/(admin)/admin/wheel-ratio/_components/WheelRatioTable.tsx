...
export default function WheelRatioTable({ wheelRatios, setSelectedYear, onDeleteOpen, onEditOpen }: any) {
  ...
  return (
    <div className="overflow-x-auto shadow-md rounded-lg">
      <Table aria-label="Wheel Ratios Table">
        ...
        <TableBody items={wheelRatios.data}>
          {(item: any) => (
