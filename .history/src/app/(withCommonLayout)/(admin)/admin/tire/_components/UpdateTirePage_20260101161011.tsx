    ...
    <div className="p-6 pb-20">
      <FormProvider {...methods}>
        <form
          ...
          {/* Pricing Section */}
          <div className="space-y-6">
            <h2 className="text-2xl font-black italic uppercase text-rose-600">
              2. Pricing & Bulk Deals
            </h2>
            <Divider />
          ...
          <div className="space-y-6">
            ...
            <Divider />
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 bg-gray-50 p-6 rounded-3xl border">
              <MakeSelectForTyre
          ...
          {/* All Range Fields (Interface Coverage) */}
          <div className="space-y-6">
          ...
          {/* Addons & Images remain same... */}
          <div className="space-y-6">
            <h2 className="text-2xl font-black italic uppercase">5. Images</h2>
            <Divider />
            <label
              htmlFor="images"
              className="flex h-24 w-full cursor-pointer items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 transition-all">
              <UploadCloud className="text-gray-400" />{" "}
              <span>Upload Performance Images</span>
              <input
                multiple
                className="hidden"
                id="images"
            ...
            <div className="flex flex-wrap gap-4 mt-4">
              {imagePreviews.map((src, index) => (
                <div
                  key={index}
                  className="relative size-28 border rounded-2xl overflow-hidden group shadow-lg">
                  <img
                    src={src}
          ...
          <Button
            type="submit"
            size="lg"
            className="w-full bg-rose-600 text-white font-black italic h-16 rounded-2xl shadow-xl shadow-rose-500/20 active:scale-95"
            isLoading={updateTirePending}>
            COMMIT UPDATE TO TRACK
          </Button>
        </form>
      </FormProvider>
    </div>
...
// ✅ ড্রপডাউন সিলেক্ট কম্পোনেন্টগুলো (সবগুলো এখানে আছে)
