...
const SingleOrderPage = () => {
  ...
  const getStatusConfig = (status: string) => {
    const configs: any = {
      ...
      refunded: {
        color: "default",
        badgeClass: "bg-default text-default-foreground",
        borderClass: "border-default",
        bgClass: "bg-default/5",
      },
    };
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-3 sm:p-4 md:p-6 lg:p-8">
      <div className="max-w-[1600px] mx-auto space-y-4 md:space-y-6">
        ...
        {/* Status Banner */}
        <Card
          className={`rounded-lg shadow-sm border-2 ${getStatusConfig(order.status).borderClass}`}>
          <CardBody
            className={`p-4 md:p-6 ${getStatusConfig(order.status).bgClass}`}>
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <div
                  className={`inline-flex items-center rounded-lg font-black uppercase text-sm px-4 py-2 ${getStatusConfig(order.status).badgeClass}`}>
                  {order.status}
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="h-16 w-16 bg-gradient-to-br from-danger to-danger/70 rounded-lg flex items-center justify-center text-white font-black text-2xl flex-shrink-0 shadow-lg">
            ...
            <Card className="rounded-lg shadow-sm border border-divider sticky top-4">
              ...
              <CardBody className="p-4 md:p-6 space-y-4">
                ...
                <div className="bg-gradient-to-r from-danger/10 to-danger/5 p-4 rounded-lg border-l-4 border-danger">
                  <div className="flex flexjustify-between items-center mb-2">
