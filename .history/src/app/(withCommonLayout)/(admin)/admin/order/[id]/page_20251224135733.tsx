              ...
              <CardBody className="p-0">
                {order.items.map((item: any, idx: number) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className="p-6 flex flex-col md:flex-row items-center gap-8 border-b border-divider last:border-0 hover:bg-default-50/50 transition-colors">
                      ...
                      <div className="flex-1 text-center sm:text-left space-y-4">
                        ...
                        {/* --- THE FIX: INSTALLATION & ADDONS BREAKDOWN --- */}
                        <div className="flex flex-wrap justify-center sm:justify-start gap-3">
                          <div className="flex items-center gap-1.5 text-[10px] font-bold text-default-500 uppercase">
                            <Package size={12} /> Base: ${item.price.toFixed(2)}
                          </div>
                          {item.installationFee > 0 && (
                      ...
                      <div className="text-center sm:text-right border-t sm:border-t-0 sm:border-l border-divider pt-4 sm:pt-0 sm:pl-8">
