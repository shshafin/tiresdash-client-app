                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="h-16 w-10 bg-gradient-to-br from-danger to-danger/70 rounded-lg flex items-center justify-center text-white font-black text-2xl flex-shrink-0 shadow-lg">
