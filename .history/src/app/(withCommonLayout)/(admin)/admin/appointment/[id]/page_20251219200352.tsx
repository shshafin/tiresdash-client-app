...
const SingleAppointmentPage = () => {
  ...
  // FIX: services is an array of populated service objects
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <span
                className={`px-4 py-2 rounded-xl text-sm font-black border uppercase tracking-tight ${getStatusColor(
                  appointment.status
                )}`}>
            ...
            <div className="bg-content1 rounded-3xl border border-divider p-6 md:p-8 shadow-sm">
              ...
              <div className="space-y-4">
                {services.length > 0 ? (
                  ...
                  <div className="p-8 text-center bg-default-50 rounded-2xl border border-dashed border-divider">
                    <p className="text-default-400">
                      No services found in this appointment.
                    </p>
                  </div>
                )}
                ...
                {appointment.additionalNotes && (
                  <div className="mt-6 p-5 bg-blue-50 dark:bg-blue-900/10 rounded-2xl border border-blue-100 dark:border-blue-900/30">
                    ...
                    <p className="text-sm text-default-700 dark:text-default-400 italic">
                      "{appointment.additionalNotes}"
                    </p>
                  </div>
                )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-content1 rounded-3xl border border-divider p-6 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-4 pt-2 border-t border-divider">
                  <div className="p-2 bg-default-100 rounded-lg mt-1">
                    <MapPin className="w-4 h-4" />
                  </div>
                  <div className="text-xs font-medium text-default-500 space-y-0.5">
