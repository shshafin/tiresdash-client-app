  ...
  const { mutate: handleUpdateWheel, isPending: updatePending } =
    useUpdateWheel({
      onSuccess: () => {
        ...
        toast.success("Wheel Performance Record Synchronized!");
      },
      id: params.id,
    });
    ...
    <div className="p-6 bg-[#fcfcfc] dark:bg-black min-h-screen pb-24">
      <FormProvider {...methods}>
        <form
          ...
          {/* SECTION 3: TECHNICAL PERFORMANCE SPECS */}
          ...
          {/* SECTION 4: WHEEL DIMENSIONS & DETAILS */}
          <div className="bg-white dark:bg-[#0f1115] p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm border-l-8 border-l-blue-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              />
              <FXInput
                label="Hub Bore (String)"
                name="hubBore"
                defaultValue={selectedWheel?.hubBore}
              />
              <FXInput
                label="ATV Offset (String)"
                name="ATVOffset"
                defaultValue={selectedWheel?.ATVOffset}
              />
              <FXInput
                label="Bolts Quantity (String)"
                name="BoltsQuantity"
          ...
          <div className="bg-white dark:bg-[#0f1115] p-8 rounded-[40px] border border-gray-100 dark:border-gray-800 shadow-sm">
            ...
            <label
              htmlFor="images"
              className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed rounded-[32px] cursor-pointer bg-gray-50 border-gray-200">
              <UploadCloud
                size={30}
...
// ✅ ড্রপডাউন সিলেক্ট কম্পোনেন্টগুলো (Make, DrivingType, etc.) সব নিচে দেওয়া হলো
