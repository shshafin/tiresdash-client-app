...
export default function UpdateWheelPage({
  ...
  const { mutate: handleUpdateWheel, isPending: updatePending } =
    useUpdateWheel({
      onSuccess: () => {
        ...
        toast.success("Wheel Specs and Assets Synchronized!");
      },
      id: id,
    });
  ...
  const onEditSubmit: SubmitHandler<FieldValues> = async (data) => {
    ...
    const wheelData: any = {
      ...
      images: remainingOldImages, // অবশিষ্ট ইমেজ লিস্ট

      // ইন্টারফেস অনুযায়ী সব নাম্বার ফিল্ডস
    ...
    formData.append("data", JSON.stringify(wheelData)); // ব্যাকএন্ড 'data' রিসিভ করছে
    ...
    <div className="p-6 bg-[#fcfcfc] dark:bg-black min-h-screen pb-24">
      <FormProvider {...methods}>
        <form
          ...
          {/* SECTION 2: PERFORMANCE SELECTORS */}
          ...
          {/* SECTION 3: WHEEL TECHNICAL SPECIFICATIONS */}
...
// [MakeSelectForWheel, DrivingTypeSelectForWheel, etc. সব ড্রপডাউন নিচে থাকবে]
