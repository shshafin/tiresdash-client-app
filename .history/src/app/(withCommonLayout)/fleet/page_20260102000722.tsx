...
const CTAButton = ({
  ...
  <Link
    ...
    <motion.span
      className={`inline-flex items-center px-8 py-4 bg-orange-600 hover:bg-white hover:text-black text-white font-black uppercase italic tracking-widest text-[10px] sm:text-xs rounded-none skew-x-[-12deg] shadow-[0_0_20px_rgba(234,88,12,0.3)] transition-all duration-500 ${className}`}
    ...
    <div className="min-h-screen bg-white dark:bg-[#050505] text-gray-900 dark:text-white transition-colors duration-500">
      ...
      <section className="py-32 px-4 bg-gradient-to-br from-orange-600 via-red-900 to-black text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <CTAButton className="bg-white text-black text-orange-600 hover:bg-black hover:text-white border-0 py-6 px-12">
