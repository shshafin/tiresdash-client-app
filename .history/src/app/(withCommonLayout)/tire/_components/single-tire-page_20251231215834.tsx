...
const SingleTirePage = ({ params }: { params: { id: string } }) => {
  ...
  const [tireSet, setTireSet] = useState(1); // Default set logic
  ...
  // ✅ Review Delete Fix: Added invalidateQueries to ensure instant update
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            {/* Selection Logic: Single Unit Removed, High-Contrast Bulk Buttons */}
            <div className="space-y-6">
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${
                    tireSet === 2
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-[#1a1d23] p-2 rounded-[24px] w-full md:w-fit border border-gray-100 dark:border-gray-800 justify-between">
                  <button
                    onClick={() => setQuantity(Math.max(1, quantity - 1))}
                    className="h-12 w-12 flex items-center justify-center rounded-full hover:bg-white shadow-sm transition-all">
                    <Minus size={18} />
                  </button>
        ...
        {/* Technical Data Tabs - Mobile Responsive Fix */}
            ...
            <Tab
              ...
              <Card className="mt-6 rounded-[32px] border-none bg-gray-50 dark:bg-[#1a1d23]">
                <CardBody className="p-8 md:p-12">
                  {/* Full geometry and load details remain here (restored fields) */}
