...
const ProductCard = ({ tire }: { tire: any }) => {
  ...
  return (
    <div className="relative mt-20 mb-2 group h-full">
      ...
      <div className="bg-white dark:bg-[#1a1d23] rounded-[48px] p-5 sm:p-7 pt-2 border border-gray-100 dark:border-gray-800 shadow-sm flex flex-col h-full transition-all duration-500 hover:shadow-2xl">
