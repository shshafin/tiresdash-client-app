            ...
            <div className="space-y-6">
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={`flex-1 py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${tireSet === 4 ? "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-500 text-white scale-[1.02]" : "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-500 dark:border-gray-700 text-gray-400 opacity-60 hover:opacity-100"}`}>
                  <span className="font-black text-sm uppercase italic">
                    Full Set (4 PC)
                  </span>
                  <span className="text-[9px] font-bold uppercase tracking-tighter opacity-80">
