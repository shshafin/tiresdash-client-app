...
const SingleTirePage = ({ params }: { params: { id: string } }) => {
  ...
  const [tireSet, setTireSet] = useState(1); // Package selection

  // --- REVIEW STATE (From your working code) ---
  const [showReviewForm, setShowReviewForm] = useState(false);
  const [editingReview, setEditingReview] = useState<any>(null);
  const [reviewForm, setReviewForm] = useState({ rating: 5, comment: "" });

  // --- LOGIC HOOKS (From your working code) ---
      ...
      <div className="container mx-auto px-4 py-4 md:py-6 max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="space-y-4">
            <div className="relative aspect-square rounded-[24px] md:rounded-[40px] overflow-hidden bg-[#f8f9fb] dark:bg-[#1a1d23] border border-gray-100 group">
              <Image
                src={
          ...
          <div className="flex flex-col">
            ...
            <h1 className="text-3xl md:text-6xl font-black text-gray-900 dark:text-white uppercase italic tracking-tighter leading-none mb-6">
              {tire?.name}
            </h1>
            ...
            <div className="space-y-6">
              <div className="flex gap-2">
                {[1, 2, 4].map((s) => (
                  <button
                    ...
                    className={`flex-1 py-3 rounded-xl font-black text-[10px] md:text-xs transition-all border-2 ${tireSet === s ? "bg-orange-600 border-orange-600 text-white" : "border-gray-200 dark:border-gray-800 text-gray-500"}`}>
                    {s === 1 ? "SINGLE" : `${s} TIRES`}
                  </button>
                ))}
              </div>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-[#1a1d23] p-2 rounded-[20px] w-full md:w-fit border border-gray-100 justify-between">
                  <button
                ...
                <Button
                  ...
                  className="w-full md:flex-1 h-16 md:h-20 bg-gradient-to-r from-orange-600 to-orange-500 text-white rounded-[20px] md:rounded-[24px] text-sm md:text-lg font-black uppercase tracking-widest shadow-xl shadow-orange-500/20">
        ...
        {/* Tab Selection with All Fields Restored */}
              ...
              <div className="mt-8 grid gap-8 lg:grid-cols-3">
                <div className="lg:col-span-1">
                  <div className="bg-gradient-to-br from-orange-600 to-orange-500 text-white p-8 rounded-[32px] text-center sticky top-24">
                    <p className="uppercase font-black text-[10px] mb-2 opacity-80">
                      Avg. Score
                    </p>
                ...
                <div className="lg:col-span-2 space-y-6">
                  {/* REVIEW FORM (Logic from your working code) */}
                  {showReviewForm && (
                    <Card className="rounded-[32px] p-2 bg-gray-50 dark:bg-gray-900 border-2 border-dashed border-orange-200">
                      <CardBody className="p-6">
                        ...
                        <div className="space-y-6">
                          ...
                          <textarea
                            ...
                            className="w-full p-6 bg-white dark:bg-[#0f1115] rounded-3xl min-h-[150px] border-none outline-none font-medium"
                            placeholder="Describe the grip and noise..."
                          />
                          <div className="flex gap-4">
                            <Button
                              ...
                              className="bg-orange-600 text-white font-black uppercase h-12 rounded-xl px-8">
                              Submit
                            </Button>
                            <Button
                              onPress={() => {
                              ...
                              variant="light"
                              className="font-black uppercase text-gray-500">
                              Cancel
                            </Button>
                          </div>
                        </div>
                  ...
                  {/* REVIEW LIST (Logic from your working code) */}
                  {reviews.length === 0 ? (
                    <p className="text-center py-20 font-black text-gray-400 uppercase tracking-widest">
                      No mark left yet.
                    </p>
                  ) : (
                    reviews.map((r: any) => (
                      <div
                        key={r._id}
                        className="bg-gray-50 dark:bg-[#1a1d23] p-8 rounded-[32px] border group">
