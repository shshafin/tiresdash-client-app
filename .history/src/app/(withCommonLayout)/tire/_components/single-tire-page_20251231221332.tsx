            ...
            <div className="space-y-6">
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex-1 py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${tireSet === 2 ? "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-500 text-white scale-[1.02]" : "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-500 dark:border-rose-500 text-gray-400 opacity-60 hover:opacity-100"}`}>
