            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <Button
                  ...
                  className="w-full md:flex-1 h-20 bg-gradient-to-r from-blue-800 via-blue-700 to-blue-600 hover:from-blue-900 to blue-900 text-white rounded-[24px] text-lg font-black uppercase tracking-widest shadow-xl shadow-blue-500/30 active:scale-95 transition-all group">
