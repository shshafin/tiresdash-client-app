          ...
          <div className="flex flex-col">
            ...
            <div className="space-y-6">
              <div className="flex flex-wrap gap-3">
                {/* Pair (2) Button - Default Rose Gradient */}
                <button
                  onClick={() => {
                    setTireSet(2);
                    setQuantity(1);
                  }}
                  className={`flex-1 min-w-[140px] py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${
                    tireSet === 2
                      ? "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-400 text-white scale-[1.05] ring-4 ring-rose-500/20"
                      : "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-500 text-white/90 opacity-90 hover:opacity-100"
                  }`}>
                  <span className="font-black text-sm uppercase italic">
                    Buy Pair (2 PC)
                  </span>
                  <span className="text-[9px] font-bold uppercase tracking-tighter opacity-80 text-rose-100">
                    Safety & Balance
                  </span>
                </button>

                {/* Full Set (4) Button - Default Emerald Gradient */}
                <button
                  onClick={() => {
                    setTireSet(4);
                    setQuantity(1);
                  ...
                  className={`flex-1 min-w-[140px] py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${
                    tireSet === 4
                      ? "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-400 text-white scale-[1.05] ring-4 emerald-500/20"
                      : "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-500 text-white/90 opacity-90 hover:opacity-100"
                  }`}>
                  <span className="font-black text-sm uppercase italic">
                    Full Set (4 PC)
                  </span>
                  <span className="text-[9px] font-bold uppercase tracking-tighter opacity-80 text-emerald-100">
                    Ultimate Performance
                  </span>
                </button>

                {/* ✅ মিশন ৪: Single Unit Toggle */}
                {(tireSet === 2 || tireSet === 4) && (
                  <button
                    onClick={() => {
                      setTireSet(1);
                    ...
                    className="w-full mt-2 py-4 rounded-2xl bg-gray-100 dark:bg-white/5 border-2 border-dashed border-gray-300 dark:border-white/20 text-gray-600 dark:text-gray-300 font-black uppercase italic text-[11px] tracking-[0.2em] hover:bg-orange-600 hover:text-white hover:border-orange-500 transition-all animate-in fade-in slide-in-from-top-3">
              ...
              {/* Quantity & High-Speed Buy Now Section */}
              <div className="flex flex-col md:flex-row gap-4">
                {/* Quantity Selector */}
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-[#1a1d23] p-2 rounded-[24px] w-full md:w-fit border border-gray-100 dark:border-gray-800 justify-between px-6 shadow-inner">
                  <button
                    onClick={() => setQuantity(Math.max(1, quantity - 1))}
                    className="h-12 w-12 flex items-center justify-center rounded-full hover:bg-white dark:hover:bg-gray-800 transition-all shadow-sm text-gray-900 dark:text-white">
                    <Minus size={18} />
                  </button>
                ...
                {/* ✅ মিশন ৩: Sporty Buy Now Button with Direct Cart Logic */}
                <Button
                  ...
                  className="w-full md:flex-1 h-20 bg-gradient-to-r from-blue-900 via-blue-700 to-blue-800 text-white rounded-[24px] text-lg font-black uppercase tracking-widest shadow-[0_15px_30px_rgba(30,58,138,0.4)] active:scale-95 transition-all group relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                  <span className="flex items-center justify-center gap-4 relative z-10">
                    <ShoppingCart
                      size={24}
                      className="group-hover:rotate-[-12deg] group-hover:scale-110 transition-transform duration-300"
                    />
                    <span className="italic">ENGAGE BUY NOW</span>
                    <div className="flex items-center -space-x-1 group-hover:translate-x-2 transition-transform duration-300">
                      <ChevronRight
                        size={22}
