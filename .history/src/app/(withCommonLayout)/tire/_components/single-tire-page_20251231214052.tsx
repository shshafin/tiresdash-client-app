      ...
      <div className="container mx-auto px-4 py-4 md:py-6 max-w-7xl">
              ...
              <div>
                ...
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-[10px] md:text-xs font-bold">
                    {averageRating.toFixed(1)} Pit Score
                  </span>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-12">
          {[
            ...
            <div
              key={i}
              className="bg-gray-50 dark:bg-[#1a1d23] p-4 md:p-6 rounded-3xl border border-gray-100 dark:border-gray-800">
              <stat.icon
        ...
        {/* Specs, Description & Restored Review Form */}
        <div className="mt-20">
          <Tabs
                ...
                <CardBody className="p-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="p-4 bg-white dark:bg-black/20 rounded-2xl">
                      <h4 className="font-black uppercase text-[10px] text-orange-600 mb-1">
                        Product Line
                      </h4>
                      <p className="font-black italic">{tire?.productLine}</p>
                    </div>
                    <div className="p-4 bg-white dark:bg-black/20 rounded-2xl">
                      <h4 className="font-black uppercase text-[10px] text-orange-600 mb-1">
                        Condition Info
                      </h4>
                      <p className="font-black italic">{tire?.conditionInfo}</p>
                    </div>
                  </div>
                </CardBody>
              </Card>
              ...
              <div className="mt-8 grid gap-8 lg:grid-cols-3">
                <div className="lg:col-span-1">
                  <div className="bg-gradient-to-br from-orange-600 to-orange-500 text-white p-8 rounded-[32px] text-center sticky top-24">
                    ...
                    <h2 className="text-7xl font-black italic mb-6">
                      {averageRating.toFixed(1)}
                    </h2>
                    {user && !showReviewForm && (
                      <Button
                        onPress={() => setShowReviewForm(true)}
                        className="w-full bg-white text-orange-600 font-black uppercase h-14 rounded-2xl">
                        Write Review
                      </Button>
                    )}
                  </div>
                    ...
                    <Card className="rounded-[32px] p-2 bg-orange-50 dark:bg-orange-950/10 border-2 border-dashed border-orange-200">
                      <CardBody className="p-6">
                        ...
                        <textarea
                          ...
                          className="w-full p-6 bg-white dark:bg-[#0f1115] rounded-3xl min-h-[150px] mb-6 border-none outline-none font-medium text-sm"
                          placeholder="Tell us about the grip and handling..."
                        />
                        <Button
                          onPress={() => {
                            if (editingReview)
                          ...
                          className="bg-orange-600 text-white font-black uppercase px-12 h-12 rounded-xl">
                          Submit Pit Stop Review
                        </Button>
                      </CardBody>
                    </Card>
                  )}
