          ...
          <div className="flex gap-2">
           <button
              ...
              onClick={() => {
                if (!user) {
                  toast.error("Please login to add items to cart");
                  // Note: Use router.push instead of redirect in an onClick handler 
                ...
                handleAddItemToCart({
                  ...
                  productType: "tire",
                  quantity: 1,
                  selectedAddons: [], // From the card, no addons are selected yet
                  hasInstallation: false, // From the card, installation isn't selected yet
                });
              }}
