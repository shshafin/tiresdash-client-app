  ...
  return (
    <div className="bg-white dark:bg-[#0f1115] min-h-screen">
      <div className="container mx-auto px-4 py-4 md:py-6 max-w-7xl">
        ...
        {/* Tab Section with Full Fields Restored */}
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card className="rounded-[32px] p-2 bg-orange-50 dark:bg-orange-950/10 border-2 border-dashed border-orange-200">
                      <CardBody className="p-6">
                        ...
                        <textarea
                          ...
                          className="w-full p-6 bg-white dark:bg-[#0f1115] rounded-3xl min-h-[150px] mb-6 border-none outline-none font-medium"
                  ...
                  {reviews.map((r: any) => (
                    <div
                      ...
                      <p className="text-gray-600 dark:text-gray-400 font-medium italic text-sm">
                        "{r.comment}"
                      </p>
                    </div>
                  ))}
