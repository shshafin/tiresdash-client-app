          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            {tire.fourSetDiscountPrice && (
              <button
                ...
                className="relative overflow-hidden group/btn bg-gradient-to-br from-emerald-800 to-slate-900 py-2.5 px-3 rounded-2xl shadow-md active:scale-95 transition-all">
                <div className="flex items-center justify-between gap-1">
                  <span className="text-[9px] font-black text-white uppercase leading-none">
                    Full Set (4)
                  </span>
