...
<div className="space-y-4 md:space-y-6">
  <div className="flex flex-wrap gap-2 md:gap-3">
    ...
    >
      <span className="font-black text-[10px] md:text-sm uppercase italic">Buy Pair (2 PC)</span>
      <span className="text-[8px] md:text-[9px] font-bold uppercase tracking-tighter opacity-80 text-rose-100">Safety & Balance</span>
    </button>
    ...
    >
      <span className="font-black text-[10px] md:text-sm uppercase italic">Full Set (4 PC)</span>
      <span className="text-[8px] md:text-[9px] font-bold uppercase tracking-tighter opacity-80 text-emerald-100">Ultimate Performance</span>
    </button>
    ...
    {(tireSet === 2 || tireSet === 4) && (
      ...
      >
        <div className="flex items-center justify-center gap-2">
           <Zap size={12} className="text-orange-500" /> RETURN TO SINGLE UNIT (1 PC)
        </div>
      </button>
    )}
  </div>
  ...
  <div className="flex flex-col md:flex-row gap-3 md:gap-4">
    ...
    <div className="flex items-center gap-3 bg-gray-50 dark:bg-[#1a1d23] p-1.5 md:p-2 rounded-2xl md:rounded-[24px] w-full md:w-fit border border-gray-100 dark:border-gray-800 justify-between px-4 md:px-6">
      ...
      <span className="text-lg md:text-xl font-black text-gray-900 dark:text-white">{quantity}</span>
      <button
