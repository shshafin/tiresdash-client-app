      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            ...
            {/* --- ৩. সেট সিলেকশন সেকশন (Updated with Single Unit Toggle) --- */}
            <div className="space-y-6">
              <div className="flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className={`flex-1 min-w-[140px] py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${tireSet === 2 ? "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-500 text-white scale-[1.02]" : "bg-gray-50 dark:bg-[#1a1d23] border-gray-100 dark:border-gray-800 text-gray-500 hover:border-rose-500"}`}>
                ...
                <button
                  ...
                  className={`flex-1 min-w-[140px] py-5 rounded-[24px] transition-all border-2 flex flex-col items-center gap-1 shadow-lg ${tireSet === 4 ? "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-500 text-white scale-[1.02]" : "bg-gray-50 dark:bg-[#1a1d23] border-gray-100 dark:border-gray-800 text-gray-500 hover:border-emerald-500"}`}>
                  <span className="font-black text-sm uppercase italic">
                    Full Set (4 PC)
                  </span>
                  <span className="text-[9px] font-bold uppercase tracking-tighter opacity-80">
                ...
                {(tireSet === 2 || tireSet === 4) && (
                  <button
                    ...
                    className="w-full mt-2 py-3 rounded-2xl bg-gray-100 dark:bg-white/5 border border-dashed border-gray-300 dark:border-white/10 text-gray-500 dark:text-gray-400 font-black uppercase italic text-[10px] tracking-widest hover:bg-orange-600 hover:text-white hover:border-transparent transition-all animate-in fade-in slide-in-from-top-2">
                    Return to Single Unit (1 PC)
                  </button>
                )}
              </div>

              {/* Quantity & Buy Now Section */}
              <div className="flex flex-col md:flex-row gap-4">
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-[#1a1d23] p-2 rounded-[24px] w-full md:w-fit border border-gray-100 dark:border-gray-800 justify-between px-6">
                  <button
                    ...
                    className="h-12 w-12 flex items-center justify-center rounded-full hover:bg-white dark:hover:bg-gray-800 transition-all shadow-sm">
                    <Minus size={18} />
                  </button>
