          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            ...
            {tire.twoSetDiscountPrice && (
              <button
                ...
                className="relative overflow-hidden group/btn bg-gradient-to-br from-rose-800 to-rose-900 py-2.5 px-3 rounded-2xl shadow-md active:scale-95 transition-all">
