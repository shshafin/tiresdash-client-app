...
interface AppointmentData {
  ...
  paymentMethod: "stripe"; // Fixed to Stripe only
}
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-black text-gray-900 mb-3 tracking-tight">
            BOOK <span className="text-red-600">SERVICE</span>
          </h1>
    ...
    <CardBody className="p-6 md:p-10 space-y-8">
          ...
          return (
            <div
              ...
              <div className="flex justify-between items-start mb-4">
                <h4
                  className={`font-bold text-base ${isSelected ? "text-red-700" : "text-gray-900"}`}>
                  {service.serviceName}
                </h4>
                <Checkbox
      ...
      <div className="flex justify-end pt-4">
        <Button
          color="danger"
          size="lg"
          className="px-10 font-bold shadow-lg shadow-red-200"
          onPress={onNext}
  ...
  return (
    <CardBody className="p-6 md:p-10 space-y-8">
      <div className="flex items-center gap-3 border-b pb-6">
        ...
        <div>
          <h2 className="text-2xl font-black text-gray-900">Choose Time</h2>
          <p className="text-sm text-gray-500">Select your preferred window</p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <label className="text-sm font-black uppercase text-gray-400 flex items-center gap-2">
    ...
    <CardBody className="p-6 md:p-10 space-y-8">
      <div className="flex items-center gap-3 border-b pb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500">Provide info for confirmation</p>
        </div>
      </div>
  ...
  return (
    <CardBody className="p-6 md:p-10 space-y-8">
      <div className="flex items-center gap-3 border-b pb-6">
        ...
        <div>
          <h2 className="text-2xl font-black text-gray-900">Review & Pay</h2>
          <p className="text-sm text-gray-500">Secure Stripe Checkout</p>
        </div>
      </div>

      <div className="space-y-4">
        <div className="bg-gray-50 p-6 rounded-3xl border-2 border-dashed border-gray-200">
          <h3 className="font-black text-gray-400 text-xs uppercase tracking-widest mb-4">
            Summary
          </h3>
  ...
  return (
    <CardBody className="text-center p-12 space-y-6">
      <div
        ...
        <div className="bg-gray-50 p-6 rounded-3xl border border-gray-200 text-left max-w-sm">
          <h4 className="font-black text-xs uppercase tracking-widest text-gray-400 mb-3">
            Reminder
          </h4>
