        ...
        <CardBody className="p-4">
          <div className="flex items-start justify-between">
            ...
            <div className="text-right">
              <Checkbox isSelected={isSelected} className="mt-2" />
            </div>
          </div>
        </CardBody>
      </Card>
      ...
      <CardBody className="space-y-6">
            ...
            <CardBody className="p-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-gray-900 mt-1">{appointmentData.schedule.time}</p>
                </div>
                <div className="col-span-2">
                  ...
                  <p className="text-gray-600">{appointmentData.user.phoneNumber}</p>
                </div>
              </div>
            </CardBody>
          </Card>
        ...
        <div>
          ...
          <div className="space-y-3">
            ...
            <Card
              className={`cursor-pointer transition-all ${appointmentData.paymentMethod === "stripe"
            ...
            >
              <CardBody className="p-4">
                <div className="flex items-center gap-4">
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-full ${appointmentData.paymentMethod === "stripe"
                      ? "bg-red-100"
                      : "bg-gray-100"
                      }`}
                  >
                    <CreditCard
                      className={`h-6 w-6 ${appointmentData.paymentMethod === "stripe"
                        ? "text-red-600"
                        : "text-gray-600"
                        }`}
                    />
            ...
            {/* Cash Payment Option */}
            <Card
              className={`cursor-pointer transition-all ${appointmentData.paymentMethod === "cash"
                ? "border-2 border-red-500 bg-red-50"
                : "border border-gray-200 hover:border-red-300"
                }`}
              isPressable
            ...
            >
              <CardBody className="p-4">
                <div className="flex items-center gap-4">
                  <div
                    className={`flex items-center justify-center w-12 h-12 rounded-full ${appointmentData.paymentMethod === "cash"
                      ? "bg-red-100"
                      : "bg-gray-100"
                      }`}
                  >
                    <ShieldCheck
                      className={`h-6 w-6 ${appointmentData.paymentMethod === "cash"
                        ? "text-red-600"
                        : "text-gray-600"
                        }`}
                    />
        ...
        <div className="flex justify-between pt-4">
          ...
          >
            {createAppointmentPending ? (
              ...
              `Confirm & ${appointmentData.paymentMethod === "cash"
                ? "Book"
...
const SuccessStep = () => {
  ...
  return (
    <CardBody className="text-center py-12">
      <div ref={printRef} className="flex flex-col items-center space-y-6 pt-8">
