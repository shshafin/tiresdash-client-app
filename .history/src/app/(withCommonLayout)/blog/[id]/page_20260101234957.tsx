...
export default function BlogDetailPage({ params }: any) {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#050505] transition-colors duration-500 pb-20">
      ...
      {/* 🏁 Hero Header Section */}
      <header className="relative pt-24 pb-12 px-4 overflow-hidden bg-gradient-to-b from-sky-50 dark:from-sky-950/20 to-transparent">
      ...
      <main className="max-w-7xl mx-auto px-4 mt-12">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            {/* 🖼️ Feature Image - Unified Style with Container & Height Boost */}
            <div className="relative aspect-video sm:h-[550px] overflow-hidden group shadow-2xl border border-white/5 rounded-xl sm:rounded-none">
              <Image
          ...
          <aside className="lg:col-span-4 space-y-6">
            {/* Mission Intel Card */}
            <div className="bg-gray-900 dark:bg-[#0f1115] p-8 rounded-none sm:rounded-tr-[40px] sm:rounded-bl-[40px] border border-sky-500/20 shadow-2xl sticky top-24">
              ...
              <div className="mt-10 relative">
                <button
                  ...
                  className="w-full bg-sky-600 hover:bg-white hover:text-black text-white py-4 rounded-xl font-black uppercase italic tracking-widest text-[10px] flex items-center justify-center gap-3 transition-all duration-500 shadow-xl">
