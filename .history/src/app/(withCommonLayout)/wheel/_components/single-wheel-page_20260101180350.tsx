              ...
              <div className="flex flex-wrap gap-3">
                ...
                {wheel?.twoSetDiscountPrice > 0 && (
                  <button
                    ...
                    className={`flex-1 py-5 rounded-[24px] border-2 flex flex-col items-center transition-all ${wheelSet === 2 ? "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-400 text-white shadow-lg scale-[1.02]" : "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-400 dark:border-gray-800 text-gray-900 dark:text-white hover:border-rose-400"}`}>
