  ...
  return (
    <div className="relative mt-20 mb-2 group h-full">
      ...
      <div
        ...
        className="absolute -top-10 -left-0 z-30 w-36 h-36 sm:w-44 sm:h-40 cursor-pointer transition-transform duration-500 group-hover:scale-110 group-hover:rotate-12">
        <img
