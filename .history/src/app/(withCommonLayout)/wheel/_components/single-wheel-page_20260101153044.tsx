            ...
            <div className="space-y-6">
              <div className="flex flex-wrap gap-3">
                <button
                  ...
                  className={`flex-1 py-5 rounded-[24px] border-2 flex flex-col items-center ${wheelSet === 2 ? "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-400 text-white" : "bg-gradient-to-br from-rose-600 to-rose-900 border-rose-500 text-white opacity-60"}`}>
                ...
                <button
                  ...
                  className={`flex-1 py-5 rounded-[24px] border-2 flex flex-col items-center ${wheelSet === 4 ? "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-400 text-white" : "bg-gradient-to-br from-emerald-600 to-emerald-900 border-emerald-500 text-white opacity-60"}`}>
                  <span className="font-black text-sm uppercase">
                    Full Set (4 PC)
                  </span>
                  <span className="text-[9px] font-bold opacity-80">
