  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#050505] text-gray-900 dark:text-white transition-colors duration-500">
      ...
      <main className="max-w-5xl mx-auto py-16 px-4">
        ...
        <div className="mt-20 p-8 sm:p-12 rounded-[40px] bg-gray-900 dark:bg-[#0f1115] border border-white/5 relative overflow-hidden text-center sm:text-left">
          ...
          <div className="relative z-10 flex flex-col sm:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-[9px] sm:text-[11px] font-bold text-gray-500 uppercase tracking-widest">
                Our technical pit-crew is standing by for deployment.
              </p>
            </div>
            <Link href="/contact">
              <button className="bg-orange-600 text-white px-8 py-4 rounded-xl font-black uppercase italic tracking-widest text-[10px] flex items-center gap-3 hover:bg-white hover:text-black transition-all duration-500 shadow-xl">
                Contact Pit Crew{" "}
                <ChevronDown
                  className="-rotate-90"
                  size={14}
