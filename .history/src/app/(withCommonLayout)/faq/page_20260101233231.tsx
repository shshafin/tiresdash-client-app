  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#050505] text-gray-900 dark:text-white transition-colors duration-500">
      ...
      <main className="max-w-5xl mx-auto py-16 px-4">
        ...
        <div className="mt-12 sm:mt-24 p-5 sm:p-12 rounded-[24px] sm:rounded-[48px] bg-gray-900 dark:bg-[#0f1115] border-2 border-orange-600/10 relative overflow-hidden text-center sm:text-left shadow-2xl">
          {/* ⚡ Background Decorative Icon */}
          <div className="absolute top-0 right-0 p-6 opacity-[0.02] rotate-12 hidden sm:block">
            <Headphones size={120} />
          </div>
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-5 sm:gap-8">
            <div className="space-y-2 sm:space-y-4">
              ...
              <h3 className="text-2xl sm:text-5xl font-black text-white uppercase italic tracking-tighter leading-none">
                NEED A <span className="text-orange-600">QUICK REPLY?</span>
              </h3>
            ...
            <Link
              ...
              <button className="w-full sm:w-auto bg-orange-600 text-white px-6 py-3.5 sm:px-10 sm:py-6 rounded-xl sm:rounded-2xl font-black uppercase italic tracking-[0.15em] sm:tracking-[0.2em] text-[10px] sm:text-xs flex items-center justify-center gap-3 sm:gap-4 hover:bg-white hover:text-black transition-all duration-500 active:scale-95 shadow-lg">
