...
const CartPage = () => {
  ...
  // Sync with Backend
// ✅ Improved Sync Logic
  const syncServicesToBackend = useCallback((productId: string, productType: string, selections: any) => {
    ...
    const selectedAddonIds = selections.addonServices.map((idxStr: string) => {
