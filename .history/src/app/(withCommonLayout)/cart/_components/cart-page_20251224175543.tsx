...
const CartPage = () => {
  ...
  const debugCartData = () => {
    ...
    cartItems.forEach((item: CartItem) => {
      ...
      console.log("Installation Fee:", item.installationFee);
      console.log("Installation Service:", item.installationService);
      console.log("Addon Services:", item.addonServices);
      console.log("Addon Price:", item.addonPrice);
      console.log("Selected Services State:", selectedServices[item.product]);
    });

    console.log("\n=== TOTAL BREAKDOWN ===");
    console.log("Calculated Total:", calculatedTotal);
    console.log("Backend Total Price:", totalPrice);
  };
