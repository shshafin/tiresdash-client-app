...
export default function Landing() {
  ...
  // ✅ ডিলস না থাকলে এই মার্কেটিং মেসেজটা দেখাবে
  const activePromo =
  ...
  return (
    <div className="pb-20 bg-white dark:bg-black">
      ...
      <div className="relative w-full overflow-hidden group">
        ...
        {/* ⚡ High-Speed Hero Text (Moved UP to avoid card overlap) */}
        <div className="absolute top-[22%] sm:top-[25%] md:top-[28%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 w-full text-center px-4 pointer-events-none">
          <h1 className="text-5xl sm:text-7xl md:text-9xl font-black text-white uppercase italic tracking-tighter drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]">
            Tires<span className="text-orange-600">Dash</span>
          </h1>
          <div className="flex items-center justify-center gap-4 mt-2">
            <div className="h-[2px] w-8 sm:w-12 bg-orange-600 shadow-[0_0_10px_#ea580c]" />
            <p className="text-white font-black uppercase tracking-[0.3em] text-[8px] sm:text-xs md:text-sm italic">
        ...
        {/* 🛠️ Action Area (Bottom Radius Removed) */}
        <div className="relative z-40 -mt-32 sm:-mt-48 max-w-6xl mx-auto px-4">
          <div
