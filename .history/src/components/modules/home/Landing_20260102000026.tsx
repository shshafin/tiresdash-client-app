  ...
  return (
    <div className="pb-20 bg-white dark:bg-black">
      ...
      <div className="relative w-full overflow-hidden group">
        ...
        <div className="absolute top-[14%] sm:top-[22%] md:top-[26%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 w-full text-center px-4 pointer-events-none">
        ...
        <div className="relative z-40 -mt-28 sm:-mt-48 max-w-6xl mx-auto px-4">
          <div
            className="bg-white/95 dark:bg-black backdrop-blur-3xl 
