          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-8 w-full">
              <Button
                ...
                className="flex-1 h-14 py- rounded-xl font-black uppercase italic text-[10px] border-2 dark:text-white">
                Reset
              </Button>
              <Button
                onPress={() => setMainStep(3)}
                className="flex-[2] h-14 bg-gradient-to-r from-orange-600 via-rose-600 to-orange-700 text-white rounded-xl font-black uppercase italic text-xs tracking-[0.15em] shadow-xl">
                Launch Catalog{" "}
                <ArrowRight
                  size={18}
                  className="ml-2"
