            ...
            <div className="relative h-full bg-white dark:bg-[#111318] rounded-2xl p-8 border-b-4 border-blue-600 shadow-2xl transition-all duration-500 flex flex-col hover:-translate-y-2 overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <Link
                  href="/appointment"
                  className="w-full">
                  <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-5 rounded-xl font-black uppercase italic tracking-[0.15em] transition-all duration-300 flex items-center justify-center gap-3 shadow-xl group/btn">
