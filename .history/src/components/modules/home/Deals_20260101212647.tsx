      ...
      <div className="relative z-10 py-10 bg-gray-50/50 dark:bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/deals"
              className="text-sm font-black uppercase italic tracking-widest text-gray-500 hover:text-gray-900 dark:hover:text-white transition-all flex items-center gap-2">
              >
              <button className="hidden sm:flex items-center gap-2 text-[10px] font-black uppercase italic tracking-widest text-gray-400 hover:text-orange-600 transition-colors">
