  ...
  return (
    <div className="pb-20 bg-white dark:bg-black">
      ...
      <div className="relative w-full overflow-hidden group">
        ...
        {/* 🛠️ Action Area (Floating Backdrop Blur - Bottom Radius Removed) */}
        <div className="relative z-40 -mt-28 sm:-mt-40 max-w-6xl mx-auto px-4">
          <div
            className="bg-white/90 dark:bg-[#0f1115]/95 backdrop-blur-3xl 
    rounded-t-[40px] sm:rounded-t-[56px] rounded-b-none 
    shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] 
