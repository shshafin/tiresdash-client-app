  ...
  return (
    <section className="relative py-16 px-4 bg-white dark:bg-[#050505] transition-colors duration-500">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* 🛠️ Modern Grid with Gradient Borders */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {/* Card 01: Encryption */}
          <div className="group relative p-[1.5px] rounded-[24px] bg-gradient-to-b from-orange-500/50 via-transparent to-transparent hover:from-orange-500 transition-all duration-500 shadow-lg">
            <div className="bg-gray-50 dark:bg-[#0f1115] p-6 rounded-[23px] h-full">
              <ShieldCheck
                size={24}
          ...
          {/* Card 02: Privacy */}
          <div className="group relative p-[1.5px] rounded-[24px] bg-gradient-to-b from-blue-500/50 via-transparent to-transparent hover:from-blue-500 transition-all duration-500 shadow-lg">
            <div className="bg-gray-50 dark:bg-[#0f1115] p-6 rounded-[23px] h-full">
              <CreditCard
                size={24}
          ...
          {/* Card 03: Support */}
          <div className="group relative p-[1.5px] rounded-[24px] bg-gradient-to-b from-emerald-500/50 via-transparent to-transparent hover:from-emerald-500 transition-all duration-500 shadow-lg">
            <div className="bg-gray-50 dark:bg-[#0f1115] p-6 rounded-[23px] h-full flex flex-col">
              <Headphones
                size={24}
