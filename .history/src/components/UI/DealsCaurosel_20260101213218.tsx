 ...
 if (!hasDeals) {
    return (
      <div className="relative py-12 px-4 overflow-hidden min-h-[350px] flex items-center justify-center">
        ...
        {/* 🏎️ Racing Background Elements (Reduced Opacity) */}
        ...
        <div className="relative z-10 max-w-3xl w-full mx-auto group">
          ...
          <div className="relative bg-gradient-to-br from-orange-600 via-rose-600 to-red-700 rounded-[32px] p-8 sm:p-12 shadow-[0_30px_60px_-15px_rgba(234,88,12,0.3)] overflow-hidden border border-white/20">
            
            {/* 🌊 Subtle Watermarks (Downsized) */}
            ...
            <div className="absolute -left-10 -top-10 opacity-5 transform -rotate-12 pointer-events-none">
            ...
            <div className="relative z-20 flex flex-col items-center text-center text-white">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative size-16 sm:size-20 bg-white/20 backdrop-blur-md border border-white/30 rounded-full flex items-center justify-center shadow-xl group-hover:scale-110 transition-all duration-500">
                  <Trophy className="size-8 sm:size-10 text-white drop-shadow-md" />
                </div>
              </div>

              {/* Text Highlights */}
              <div className="inline-flex items-center gap-2 bg-black/20 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10 mb-4">
                 <Zap size={12} className="fill-yellow-400 text-yellow-400" />
                 <span className="text-[9px] font-black uppercase italic tracking-[0.2em]">Maintenance Mode</span>
              </div>

              <h2 className="text-3xl sm:text-5xl font-black uppercase italic tracking-tighter leading-tight mb-4 drop-shadow-xl">
                VAULT <span className="text-black/20">LOCKED</span>
              </h2>

              <p className="text-xs sm:text-lg font-bold uppercase italic text-orange-50/70 max-w-sm mx-auto leading-snug tracking-wide">
                Recalibrating Next-Gen Offers. <br />
                <span className="text-white">Elite savings incoming.</span>
              </p>

              {/* Bottom Status (More Compact) */}
              <div className="mt-8 inline-flex items-center gap-3 bg-black/10 px-6 py-3 rounded-2xl border border-white/10 backdrop-blur-md group-hover:bg-black/20 transition-colors">
                <Clock className="size-4 text-yellow-300 animate-spin-slow" />
                <div className="flex flex-col items-start leading-none">
                  <span className="text-[8px] font-black uppercase tracking-widest opacity-50">Stage</span>
                  <span className="text-xs font-black uppercase italic tracking-tighter">Preparing Mission 04</span>
                </div>
              </div>
