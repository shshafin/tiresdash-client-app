...
const Footer = () => {
  return (
    <footer className="relative bg-[#050608] text-gray-400 mt-auto overflow-hidden">
      {/* 🏎️ Racing Stripe Accent */}
      <div className="absolute  w-full h-[3px] bg-gradient-to-r from-transparent via-orange-600 to-transparent opacity-80" />
