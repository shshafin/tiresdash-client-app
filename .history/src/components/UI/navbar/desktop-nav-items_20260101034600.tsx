...
import { ChevronDown, ArrowRight, Zap, Target, Gauge } from "lucide-react";
            ...
            <div className="flex flex-col gap-1.5">
              {section.items.map((item: any, i: number) => (
                <NextLink
                  key={i}
                  href={item.href}
                  className="group flex items-center justify-between p-2 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-950/10 transition-all">
                  <span className="text-sm font-bold text-gray-500 dark:text-gray-400 group-hover:text-orange-600 group-hover:translate-x-1 transition-all">
                    {item.name}
                  </span>
                  <Zap
                    size={10}
