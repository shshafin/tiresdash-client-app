...
const SportyDropdown = ({
  ...
  return (
    <div className="bg-white dark:bg-[#0b0d11] border-t-4 border-orange-600 rounded-b-[2.5rem] shadow-[0_40px_80px_-15px_rgba(0,0,0,0.5)] p-10 animate-in fade-in slide-in-from-top-4 duration-300 w-[1000px] border-x border-b border-gray-100 dark:border-white/5">
