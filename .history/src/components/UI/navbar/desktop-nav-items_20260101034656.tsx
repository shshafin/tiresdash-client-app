...
// --- Improved Sporty Dropdown Component ---
  ...
  return (
    <div className="bg-white dark:bg-[#0b0d11] border-t-4 border-orange-600 rounded-b-3xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] p-10 animate-in fade-in slide-in-from-top-4 duration-300 w-[950px]">
      <div className="grid grid-cols-4 gap-10">
        {/* Dynamic Sections (Vehicle Type, Performance etc.) */}
            ...
            <div className="flex flex-col gap-1.5">
              {section.items.map((item: any, i: number) => (
                <NextLink
                  ...
                  {/* ✅ Fixed: Changed text-orange-600 to text-gray-500/dark:text-gray-400, turns black on hover */}
        ...
        return (
          <SportyDropdown
            sections={[
              {
                title: "Wheel Styles",
                // ✅ Key ensured as widthType to match your hook data
        ...
        {navItems.map((item) => (
          <NavbarItem
            ...
            <div
              ...
              className="py-6">
              {/* ✅ Fixed: Conditional rendering to handle Links vs Dropdowns */}
              {item.hasDropdown ? (
                <div
                  className={clsx(
                    "px-5 py-2.5 rounded-xl transition-all duration-300 flex items-center gap-2 cursor-pointer",
                ...
                <NextLink
                  href={item.href}
                  className={clsx(
                    "px-5 py-2.5 rounded-xl transition-all duration-300 flex items-center gap-2",
                    "text-[11px] font-black uppercase tracking-[0.2em] italic",
                    "text-gray-600 dark:text-gray-400 hover:text-orange-600 hover:bg-gray-50/50 dark:hover:bg-orange-500/10"
                  )}>
                  {item.label}
                </NextLink>
              )}
